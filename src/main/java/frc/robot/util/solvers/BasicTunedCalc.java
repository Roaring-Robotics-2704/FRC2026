...
public class BasicTunedCalc {
    ...
    public BasicTunedCalc() {
        ...
        hoodAngleMap.put(1.0, MIN_ANGLE);
        flywheelSpeedMap.put(1.0, 1000.0);
        timeOfFlightMap.put(1.0, 1.1);

        hoodAngleMap.put(2.0, MIN_ANGLE+3);
        flywheelSpeedMap.put(2.0, 1750.0);
        timeOfFlightMap.put(2.0, 0.62);

        hoodAngleMap.put(3.0, MIN_ANGLE+10);
        flywheelSpeedMap.put(3.0, 3000.0);
        timeOfFlightMap.put(3.0, 4.0);

        hoodAngleMap.put(4.0, MIN_ANGLE+15);
        flywheelSpeedMap.put(4.0, 4000.0);
        timeOfFlightMap.put(4.0, 5.0);

        hoodAngleMap.put(5.0, MIN_ANGLE+20);
    ...
    public ShootingSolution getShootingSolution() {
        ...
        return new ShootingSolution(DegreesPerSecond.of(rotationsPerMinute * 360.0 / 60.0), hoodAngle, Rotation2d.fromRadians(targetAngle), distance);
    }
