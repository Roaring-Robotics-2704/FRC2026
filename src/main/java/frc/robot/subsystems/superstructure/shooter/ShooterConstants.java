...
public class ShooterConstants {
    ...
    public static final double SHOOTER_KP = 0.010748; // more error = more power
    public static final double SHOOTER_KD = 0.0; // predicts ROC of error, change these PID values later as needed
    public static final double SHOOTER_KV = 0.01822;
    public static final double SHOOTER_KA = 0.0014421;
    public static final double SHOOTER_KS = 0.078948;
